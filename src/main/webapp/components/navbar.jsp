<nav class="navbar navbar-expand-lg bg-light">
	<div class="container-fluid">
		<a class="navbar-brand" href="<%= request.getContextPath() %>">Menú</a>
			...
			<ul class="navbar-nav me-auto mb-2 mb-lg-0">
				...
				<li class="nav-item dropdown">
					...
					<ul class="dropdown-menu">
						<li><a class="dropdown-item" href="https://github.com/hozlucas28/Codo-Codo-Front-end-2022">Front-end</a></li>
						<li><a class="dropdown-item" href="https://github.com/hozlucas28/Codo-Codo-Back-end-2022">Back-end</a></li>
					</ul>
				</li>
			</ul>
